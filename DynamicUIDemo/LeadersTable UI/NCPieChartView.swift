...
public class NCPieChartView: UIView {
    ...
    private var items: [NCPieChartItem] = [NCPieChartItem]()
    ...
    convenience public init(items: [NCPieChartItem], centerTitle: String? = nil) {
        self.init()
        self.items = items
