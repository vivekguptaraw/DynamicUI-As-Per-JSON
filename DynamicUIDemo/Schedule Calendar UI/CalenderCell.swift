...
class CalenderCell: UICollectionViewCell {
    ...
    func updateCell(indexPath: IndexPath, dateModel: DateModel, dayDictionary: inout [String: GameDate], isFirstTime : Bool, selectedIndex: IndexPath?){
        ...
        if indexPath.section == 0 {
            ...
            if day == ""{
                self.teamLabel.text = ""
                self.dayLabel.text = ""
                self.backgroundColor = UIColor.hexStringToUIColor(hex: "d6dbd6")
            }else{
                ...
                dayDictionary[day]?.gameIndexInCollection = indexPath.row
